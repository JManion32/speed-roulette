      ...
      `}
            >
                <div className="flex flex-col items-center">
                    ...
                    <hr
                        className={`w-[32rem] mb-4 ${isDarkMode ? "border-gray-600" : "border-gray-400"}`}
                    />
                    ...
                    <hr
                        className={`w-[32rem] mt-4 ${isDarkMode ? "border-gray-600" : "border-gray-400"}`}
                    />
                ...
                ${isDarkMode ? "bg-green-500 hover:bg-green-400" : "bg-green-250 hover:bg-green-350"}
                            ...
                            onClick={async () => {
                                if (!nickname) {
                                    alert(
                                        "Nickname missing. Please reload the page.",
                                    );
                                    return;
                                }
