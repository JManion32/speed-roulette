            ...
            >
                ...
                <div className="max-h-[31.25rem] overflow-y-auto text-[1.125rem]">
                    {activeTab === "about" && (
                        <>
                            <p className="mb-6">
                                Inspired by the intensity of speed chess, Speed
                                Roulette puts an interesting twist on the
                                beloved high-stakes casino game. Players start
                                with 20 dollars, 10 possible spins, and just 60
                                seconds on the clock. When bets are submitted,
                                the winning number is revealed, earnings are
                                paid out, and the clock starts ticking again 2.5
                                seconds later. Compete for a spot on the daily
                                leaderboard by making quick decisions, taking
                            ...
                            <p>
                                I hope you enjoy my website! It has been a dream
                                come true to create this. Remember: anything is
                                possible if you put your mind to it. Best of
                                luck!
                            </p>
                        </>
                    )}
                    ...
                    {activeTab === "rules" && (
                        <>
                            <p className="mb-4">
                                ...
                                <br />
                                Bet on what the winning number will be by
                                placing chips on the betting table.
                            </p>
                            ...
                            <p className="mb-4">
                                You can also bet on multiple buttons at a time
                                with one chip (e.g., half on 7, half on 10). For
                            ...
                            <p>
                                ...
                                <ul className="list-disc pl-8 mb-6">
                                    <li>
                                        Start with $20, 10 spins, and 60 seconds
                                        on the clock.
                                    </li>
                                    <li>
                                        The timer begins when you place your
                                        first bet.
                                    </li>
                                    <li>
                                        When bets are submitted, there is a 2.5s
                                        pause before the next round where the
                                        number is revealed, and winnings are
                                        paid out.
                                    </li>
                                </ul>
                                <i>
                                    Make as much as you can before you run out
                                    of <b>time</b>, <b>spins</b>, or{" "}
                                    <b>money</b>!
                                </i>
                            </p>
                        </>
                        ...
                        <>
                            <p className="transition-color duration-200 text-[2rem] mb-10">
                                ...
                                <a
                                    ...
                                    className={`${isDarkMode ? "text-blue-500" : "text-blue-700"} underline hover:text-purple-500 transition-colors duration-100`}
                                >
