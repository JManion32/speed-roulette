  ...
  return (
    <>
      ...
      <div className="flex gap-2 justify-center w-full mb-5">
        <button 
          className={`transition-color h-12 w-45 rounded-md font-bold text-[1.25rem] mr-25 transition-transform transform hover:scale-105 ${isDarkMode ? 'text-white bg-gray-600 hover:bg-gray-500' : 'text-black bg-gray-300 hover:bg-gray-350'}`}
        ...
        <button 
          className={`transition-color h-12 w-45 rounded-md font-bold text-[1.25rem] transition duration-200 ${
