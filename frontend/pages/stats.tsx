    ...
    return (
        ...
        >
            ...
            <div className="w-full max-w-5xl mx-auto">
                <h1 className="transition duration-200 text-[4rem] font-bold mt-8 mb-8">
                    Site Statistics
                </h1>
                ...
                <div className="w-full max-w-5xl space-y-10">
                    ...
                    <div>
                        <div className="h-12">
                            <Bar
                                data={createStackedBarData(stats.colorCounts, [
                                    "red",
                                    "green",
                                    "black",
                                    "neither",
                    ...
                    <div>
                        <div className="h-12">
                            <Bar
                                data={createStackedBarData(stats.parityCounts, [
                                    "even",
                                    "neither",
                                    "odd",
                                ])}
                    ...
                    <div>
                        <div className="h-12">
                            <Bar
                                data={createStackedBarData(stats.halfCounts, [
                                    "low",
                                    "neither",
                                    "high",
                                ])}
                    ...
                    <div>
                        <div className="h-12">
                            <Bar
                                data={createStackedBarData(stats.dozenCounts, [
                                    "first",
                                    "second",
                                    "third",
                                    "neither",
                    ...
                    <div>
                        <div className="h-12">
                            <Bar
                                data={createStackedBarData(stats.rowCounts, [
                                    "top",
                                    "middle",
                                    "bottom",
                                    "neither",
