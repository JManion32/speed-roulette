            ...
            >
                ...
                <div className="max-h-[31.25rem] overflow-y-auto text-[1.125rem]">
                    {activeTab === 'about' && (
                        <>
                            <p className="mb-6">
                                Inspired by the intensity of speed chess, Speed Roulette puts an interesting twist on
                                the beloved high-stakes casino game. Players start with 20 dollars, 10 possible spins,
                                and just 60 seconds on the clock. When bets are submitted, the winning number is
                                revealed, earnings are paid out, and the clock starts ticking again 2.5 seconds later.
                                Compete for a spot on the daily leaderboard by making quick decisions, taking bold
                                risks, and hitting big payouts.
                            </p>
                    ...
                    {activeTab === 'rules' && (
                        <>
                            ...
                            <p className="mb-4">
                                You can also bet on multiple buttons at a time with one chip (e.g., half on 7, half on
                                10). For more details, see the{' '}
                                <a
                            ...
                            <p>
                                ...
                                <i>
                                    Make as much as you can before you run out of <b>time</b>, <b>spins</b>, or{' '}
                                    <b>money</b>!
                                </i>
                            </p>
                        </>
