    ...
    return (
        ...
        >
            ...
            <div className="w-full max-w-6xl mx-auto">
                <h1 className="text-[4rem] font-bold mt-8 mb-8 transition duration-200">
                    Leaderboard
                </h1>

                <div className="flex border-b border-gray-700 mb-6 space-x-6">
                    {(["today", "week", "month", "allTime"] as Range[]).map(
                        (tab) => (
                            <button
                                key={tab}
                ...
                <div className="w-full max-w-6xl overflow-x-auto">
                    {leaderboard.length > 0 ? (
                        <table className="w-full text-left border-collapse mt-4 transition duration-200">
                            ...
                            <tbody>
                                {leaderboard.map((entry, i) => (
                                    ...
                                    >
                                        <td className="pl-6 pr-20 font-bold">
                                            {i + 1}
                                        </td>
                        ...
                        <p className="text-xl mt-4 text-center transition duration-200 font-bold italic">
                            No entries yet.
                        </p>
                    )}
                </div>
